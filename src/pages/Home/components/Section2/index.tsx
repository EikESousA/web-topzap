          ...
          <section>
            ...
            <Card left>
              <div className="info">
                ...
                <span>
                  Envie mensagens de texto e áudio, arquivos em diversos
                  formatos como pdf, doc, xls, vídeos, imagens, e muito mais.
                </span>
              </div>
              <div className="img">
                <HiOutlineMusicNote />
          ...
          <section>
            ...
            <Card left={false}>
              <div className="info">
                ...
                <span>
                  ...
                  cliente recebe de forma automática, facilitando a comunicação
                  e as tratativas.
                </span>
              </div>
              <div className="img">
            ...
            <Card left={false}>
              <div className="info">
                ...
                <span>
                  A gestão tem acesso a relatórios de atendimento e acompanha
                  sua equipe em tempo real todos os dias e de qualquer lugar ou
                  dispositivo.
                </span>
              </div>
              <div className="img">
